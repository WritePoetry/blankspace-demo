...
<!-- wp:navigation {"overlayMenu":"never","style":{"typography":{"fontWeight":"400","fontWeight":"500","textTransform":"uppercase"},"spacing":{"blockGap":"var:preset|spacing|60"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"center"},"setCascadingProperties":true,"ariaLabel":"<?php esc_attr_e( 'Main Menu', 'blankspace-demo' ); ?>"} -->
    <!-- wp:navigation-link {"label":"<?php esc_html_e( 'Blog', 'blankspace-demo' ); ?>","url":"#"} /-->
